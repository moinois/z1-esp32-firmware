...
| OD-001--OD-052 CANopen object dictionary | Portable core dictionary with typed access metadata and write effects | Yes for all specified objects, defaults, access, little endian, retained writes, aborts, PDO mapping validation, and digital I/O | SDO/PDO transport, heartbeat/error composition, and diagnostic-output adapter pending |
