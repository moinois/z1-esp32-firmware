...
| BWF-010--BWF-023, BWF-033 frame envelope, security, and acknowledgement | Application implementation with replaceable cipher and notification port | Yes for exact envelope, sequences, security flags, checksum order, encryption scope, failures, and acknowledgement timing | Fragment reassembly, product dispatch, and ESP-IDF GATT adapter pending |
