...
TEST_CASE(web_010_static_paths_reject_a_256_byte_result) {
    ...
    REQUIRE_EQ(resolve_static_path(longest_uri + "a"),
...
TEST_CASE(web_012_mime_type_uses_the_specified_substring_precedence) {
    ...
    REQUIRE_EQ(static_mime_type("/styles/maincss"), std::string_view("text/css"));
