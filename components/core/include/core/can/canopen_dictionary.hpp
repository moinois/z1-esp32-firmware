...
enum class SdoAbort : std::uint32_t {
    none = 0x00000000U,
    toggle_bit = 0x05030000U,
    timeout = 0x05040000U,
    command_specifier = 0x05040001U,
    block_size = 0x05040002U,
    block_sequence = 0x05040003U,
    block_crc = 0x05040004U,
    resources = 0x05040005U,
    unsupported_access = 0x06010000U,
    write_only = 0x06010001U,
    read_only = 0x06010002U,
    object_not_found = 0x06020000U,
    pdo_mapping = 0x06040041U,
    pdo_length = 0x06040042U,
    pdo_parameter = 0x06040043U,
