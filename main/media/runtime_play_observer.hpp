/** @file @brief Declares the target play-state observer used by controller adapters. */
#pragma once

namespace firmware::target {

/** Converts playback transitions into monotonic runtime-counter notifications. */
