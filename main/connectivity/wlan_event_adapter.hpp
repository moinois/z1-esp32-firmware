/** @file @brief Declares ESP-IDF Wi-Fi/IP event registration for discovery lifecycle updates. */
#pragma once
...
/** Fans ESP-IDF station events into discovery, provisioning, and reconnect state. */
