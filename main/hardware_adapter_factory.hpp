/** @file @brief Declares the single composition point for selecting target hardware adapters. */
#pragma once
...
/** Central composition point that selects every live or mock hardware adapter. */
